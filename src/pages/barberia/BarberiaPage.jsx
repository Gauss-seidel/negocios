          ...
          <div className="mt-5 flex flex-wrap justify-center gap-5 text-sm">
            ...
            {business.phone && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-white/50 backdrop-blur-sm transition-colors hover:text-green-400"
              >
